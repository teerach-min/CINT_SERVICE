...
<div id="page-wrapper">
                                                    ...
                                                    <select id="select_status" name="Status_ID" id="status" class="form-control" tabindex="1">
                                                        ...
                                                        <?php 
                                                            if($array_h != ']' && $array_h != '[]' )
                                                            {
                                                                ...
                                                                $status_job = $this->db->where_in('Status_ID', array('2'))->get('sv_status')->result_array();
                                                            }
        ...
        $(document).ready(function() {
            ...
            //     $('input[class="chk-nonsamsung"]').prop('disabled', true);
            //     $('input[class="chk-samsung"]').prop('disabled', false);
            // });
            ...
            //     $('input[class="chk-nonsamsung"]').prop('disabled', false);
            //     $('input[class="chk-samsung"]').prop('disabled', true);
            // });
