...
<head>
    <title></title>
    <link href="css/font-license.css" rel="stylesheet">
...
<body>
    ...
    <div class="warptext">
            ...
            <p>Website: www.databar.co.th Email: Services@databar.co.th Phone: +66 (0) 99 286 4709 Fax: +66 (0) 2 102-2590
            <br>
    ...
    <table width="100%">
        <tr>
            <td width="70px">
                <p class="title-name strong title-text">Customer :</p>
            </td>
            <td>
                <p class="strong title-text">
                    <?= $rs['Quot_Customer']?>
                </p>
            </td>
            <td width="80px">
                <p class="title-name text-right strong title-text">Quotation No.:</p>
            </td>
            <td>
                <p>
                    <?= $rs['Quot_No']?>
        ...
        <tr>
            <td width="70px">
                <p class="title-name strong title-text"> Attention :</p>
            </td>
            <td>
                <p class="strong title-text">
                    <?= $rs['Quot_Attention']?>
            ...
            <td width="80px" class="text-right">
                <p class="title-name strong title-text">Date: </p>
            </td>
            <td>
                <p class="text-light">
                    <?= date('d-M-Y',strtotime($rs['Quot_Date']))?>
                </p>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td width="70px"></td>
            <td width="450px">
                <p class="text-light">Email: <span class="strong">
                        <?= $rs['Quot_Email']?></span></p>
            </td>
            <td></td>
            <td></td>
        </tr>
    ...
    <p style="padding: 10px 0 0;">We are pleased to provide you and who it may concern for the reasonable quote and
        commercial term to kindly consider of below;</p>
        ...
        <table id="table-list" width="100%">
            ...
            <?php
                ...
                <tr class="text-center">
                    <td rowspan="<?=$rowSpan?>" class="text-center" width="40px">
                        <p>
                            <?= ++$key?>
                        </p>
                    </td>
                    <td rowspan="<?=$rowSpan?>" class="text-center" width="100px">
                        <p>
                            <?= $row['Qlist_Model']?>
                        </p>
                    </td>
    ...
    <table id="table-list2" width="100%">
        <tr class="text-center">
            <td rowspan="4" class="text-center" width="100px">
                <p> จำนวนเงินตัวอักษร </p>
            </td>
            <td rowspan="4" class="text-center" width="500px">
                <p class="strong">
                    <?=$rs['Quot_Grandtotal_TH']?>
                </p>
            </td>
            <td class="text-right menu-total strong" width="80px">
                <p>Discount <?= $rs['Quot_PDiscount']?>%</p>
            </td>
            <td class="text-right" width="75px">
                <p class="strong">
                    <?=$rs['Quot_Discount']?>
                </p>
            </td>
        ...
        <tr class="text-center">
            <td class="text-right menu-total strong">
                <p>Total</p>
            </td>
            <td class="text-right">
                <p class="strong">
    ...
    <table id="table_term" width="100%" style="padding-top:5px;">
        <tr>
            <td valign="top" width="70px">
                <p class="title-name strong title-text">Remark:</p>
            </td>
            <td>
                <p>- Please sign off as fpr order confirmation and return it together with purchase order at <span
                        class="strong">Fax: +66 (0) 2 102-2590</span>
                    <br> or email us at <span class="strong">services@databar.co.th</span>
                    <br>- Order cancellation will be charged at 30% total amount</p>
            </td>
        </tr>
    </table>
    ...
    <table id="table_term" width="100%" style="padding-top:5px;">
        <tr>
            <td width="100px">
                <p class="title-name strong title-text">Commercial Term:</p>
            </td>
            <td></td>
        </tr>
        <tr>
