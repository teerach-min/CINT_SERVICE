    ...
    <style>
            ...
            <table id="table-list" width="100%">
                ...
                <?php
                    ...
                    <tr class="text-center">
                        ...
                        <td rowspan="<?=$rowSpan?>" class="text-center" width="100px"><p> <p><?= $row['Qlist_Imei']?></p>
                        <p><?= $row['Qlist_Serial']?></p></p></td>
        ...
        <table id="table-list2" width="100%">
            <tr class="text-center">
                ...
                <td class="text-right menu-total strong"><p>Discount <?=$rs['Quot_PDiscount']?>%</p></td>
                <td class="text-right" ><p class="strong"><?=$rs['Quot_Discount']?></p></td>
            </tr>
            <tr class="text-center">
        ...
        <table id="table_term" width="100%" style="padding-top:20px;">
            <tr>
                <td width="70px"><p class="title-name strong title-text">Remark:</p></td>
                <td>
                <p>- Please sign off as for order confirmation and return it together with purchase order at Fax: +66 (0) 2 102-2590 or email us at services@databar.co.th</p>
                </td>
            </tr>
            <tr>
                <td width="70px"></td>
                <td>
                <p>- Order cancellation will be charged at 30% of total amount </p>
                </td>
            </tr>
        </table>
            <br>
        <table id="table_term" width="100%" style="padding-top:5px;">
            ...
            <tr>
                <td class="text-right" ><p>Term of Payment:</p></td>
                <td><p><?= $comm['Comm_Payment']?></p></td>
            </tr>
            <tr>
        ...
        <table id="signature" class="text-center" width="100%" style="margin-top:20px">
            ...
            <tr>
                ...
                <td></td>
                <td class="border2"><span class="license"></span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="border2"><p>099 287 4709</p></td>
            </tr>
        </table>
