...
<html>
    ...
    <style>
        ...
        ?>
        <table width="100%" style="border: 2px solid #000; border-top:0px; border-bottom:0px;">
            <tr>
                <td valign="top" width="50px" align="right"><p class="strong">Remark :</p></td>
                <td><p class="note">1.ในกรณีที่ลูกค้าตกลงซ่อมรบกวนยืนยันในใบเสนอราคาและส่ง Mail ตอบกลับมาภายใน 5 วันทำการ หากไม่ได้รับการยืนยันตามนี้ทางศูนย์ซ่อมขออนุญาติส่งเครื่องกลับไปที่ดีแทค</p>
                <p class="note">2.หลังจากยืนยันการซ่อมแล้วต้องชำระเงินภายใน 10 วันทำการ รายละเอียดการชำระเงินตามด้านล่าง หากไม่ได้รับการแจ้งชำระเงินทางศูนย์ซ่อมขอออนุญาติส่งเครื่องกลับไปที่ดีแทค</p>
                <p class="note">3.หลังจากได้รับการแจ้งยอดชำระเงินเรียบร้อยแล้ว ทางศูนย์ซ่อมจะดำเนินการซ่อมต่อโดยใช้ระยะเวลาประมาณ 3 วันทำการ หลังจากซ่อมเสร็จจะส่งเครื่องกลับดีแทคในรอบส่งถัดไป </p>
                </td>
            </tr>
        </table>
