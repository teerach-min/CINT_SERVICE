...
<html>
    ...
    <body>
        ...
        <table  width="100%">
            ...
            <tr>
                <td width="100px"><p>Company Name:</p></td>
                <td><p><?= $detail['Deli_Company'];?></p></td>
                <td width="100px"><p>Contact Person:</p></td>
                <td><p><?= $detail['Deli_Contact'];?></p></td>
                <td width="30px" class="text-right"><p>Date:</p></td>
                <td width="150px"><p><?= date('d-M-Y', strtotime($detail['Deli_Date']));?></p></td>
            </tr>
            <tr>
                <td><p>Address:</p></td>
                <td colspan="3"><p><span ><?= $detail['Deli_Address'];?></span></p></td>
        ...
        <table width="100%" class="signature" style="padding-top:10px;">
            <tr >
                ...
                <p>Delivered By</p><br>
                <p>Date _______/_______/__________</p>
                </td>
            </tr>
        </table>
