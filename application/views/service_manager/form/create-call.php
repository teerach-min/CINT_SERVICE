                            ...
                            <?= form_open('service_manager/create_order',array('class'=>'needs-validation','novalidate'=>TRUE,'data-toggle'=>'validator'))?>
                                        <div class="form-body">
                                                ...
                                                <div id="SelectUser" class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <option value="" disabled hidden selected>Choose Technical</option>
                                                            <?php 
                                                            $select_user = $this->db->where_in('Status', array('Technician'))->get('sv_user')->result_array();
        ...
        $(window).load(function()
        {
            ...
            $('input[name="Regis_Phone"]').inputmask({
                mask: tel,
                greedy: false,
                definitions: { '#': { validator: "[0-9]", cardinality: 1}}
            });

            $('input[name="Regis_Mobile"]').inputmask({
                mask: mobile,
                greedy: false,
                definitions: { '#': { validator: "[0-9]", cardinality: 1}}
            });
